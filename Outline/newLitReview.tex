...
\section{Outlier/ Adversarial Detection}
    \begin{itemize}
        \item Definition of robustness and outliers
...
\section{Sensor Fusion}
    \begin{itemize}
        ...
        \item Data adjustment/ alignment
        \item Fusion of raw data/ preprocessed
        \item Manifold alignment 
        \item (Pick highly cited/ well-known over broad range (this is a large field))
    \end{itemize}
