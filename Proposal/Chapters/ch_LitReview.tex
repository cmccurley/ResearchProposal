...
This section provides discussion on the unsupervised manifold learning methods reviewed.  Specifically, Section \ref{sec:Manifold_Learning_Discussion_Comp_Table} provides a table summarizing each of the aforementioned manifold learning approaches.  Section \ref{sec:Manifold_Learning_Discussion_Relations} discusses relationships between each of the methods while Section \ref{sec:Manifold_Learning_Discussion_Comp_Strengths} elaborates on individual strengths and weaknesses.
...
\subsubsection{Relations} \label{sec:Manifold_Learning_Discussion_Relations}
...
\subsubsection{Strengths and Weaknesses} \label{sec:Manifold_Learning_Discussion_Comp_Strengths}

Are not capable of reliably learning useful, discriminative low-dimensional features from weakly-supervised data.  (Could neglect labels entirely or use bag-level labels.)
