...
\subsubsection{Gaussian Process Latent Variable Model (GPLVM)} \label{sec:GLVM}
...
\begin{longtable}{ |p{0.25\textwidth}|p{0.6\textwidth}|p{0.08\textwidth}| } 
	...
	\hline
	SNE and t-SNE  & Defines pairwise probabilities of samples being neighbors.  Minimizes the KL-divergence between high and low-dimensional data densities. Retains global and local data structure. Section \ref{sec:tSNE} & 2008 \\
	\hline
