...
Section \ref{sec:KPCA} described how Kernel PCA allows PCA to be performed in a features space defined by a kernel function $\kappa$.  However, the choice of kernel function is arbitrary and a chosen kernel may not be optimal for learning the intrinsic structure for a set of data.  To resolve this issue, \textit{Maximum Variance Unfolding} (MVU, formerly known as \textit{Semidefinite Embedding}) attempts to learn an appropriate kernel matrix \citep{Weinberger2004MVU}. 
...
\begin{longtable}{ |p{0.3\textwidth}|p{0.6\textwidth}| } 
	...
	\hline
	Diffusion Maps  & Preserves diffusion distance  \\
	\hline
