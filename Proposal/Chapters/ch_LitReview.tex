...
\begin{longtable}{ |p{0.3\textwidth}|p{0.6\textwidth}| } 
	...
	\textbf{Method} & \textbf{Strategy}\\
	\hline
	KPCA  & Performs PCA in a feature space defined by a kernel function, preserves variance of data, global structure   \\
	\hline
	MVU  & Learns a kernel function to be used with KPCA that ``unfolds" the manifold, preserves variance of data, global structure  \\
	\hline
