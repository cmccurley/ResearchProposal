...
The majority of MIL classification approaches in the literature can be categorized by their learning procedures.  The categories discussed in this review are: Axis-Parallel Concepts, Maximum Likelihood, Distance-Based, Maximum Margin and Deep Learning, Probabilistic Graphical Methods and Ensembles of Classifiers.  Each approach is reviewed in the following.
