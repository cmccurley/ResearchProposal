...
\begin{longtable}{ |p{0.3\textwidth}|p{0.6\textwidth}| } 
	...
	\hline
	Hessian LLE  & Minimizes curvature of high-dimensional manifold estimated from local neighborhoods  \\
	\hline
	LTSA  &  Learns manifold in local tangent spaces then aligns to form global coordinate system \\
	\hline
	Diffusion Maps  & ~  \\
	\hline
	MVU  & ~   \\
