...
Two types of features were explored for high-dimensional bag representation in this work, namely, hand-crafted Histogram of Oriented Gradients (HOG) and features taken from a convolutional neural network (CNN).  

\subsubsection{HOG Features}

Figure \textbf{REFERENCE} demonstrates HOG  features
