...
In this chapter, a summary is provided of initial experiments using the proposed method for discriminative manifold learning and dimensionality reduction. 
