...
\begin{figure*}[t!]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		...
		\caption{}
		\label{fig:quad_surface_lin_sep_le_1d}
	\end{subfigure}%
	~ 
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
	...
	\end{subfigure}
\caption[Quadratic surfaces no labels]{}
...
\begin{figure*}[t!]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[height=2.2in]{"introduction/quad_surface_lin_sep_bags"}
		\caption{}
		\label{fig:quad_surface_lin_sep_bags}
	\end{subfigure}%
	~ 
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
	...
	\end{subfigure}
\caption[Quadratic surfaces with bag-level labels]{}
