...
\begin{figure*}[t!]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption[\textcolor{orange}{Examples of image-level labels.}]{\textcolor{orange}{Example of image-level labels for binary target detection.  Image (a) is denoted to contain pixels belonging to the target class somewhere within the image, while image (b) clearly contains samples solely from the background distribution.}}
